    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className='group relative'>
          <img src={assets.profile_icon} alt="Cart" className='w-5 h-5 cursor-pointer' />
        ...
        <Link to='/cart' className='relative'>
            ...
            <p className="absolute right-[-5px] top-[-5px] w-4 text-center leading-4 bg-black text-white rounded-full text-[8px]">10</p>
        </Link>
        <img onClick={()=>setVisible(true)} src={assets.menu_icon} alt="Menu" className='w-5 cursor-pointer sm:hidden'></img>
      </div>
